package com.hana.storyapplication.data.paging
...
import com.hana.storyapplication.data.database.RemoteKeys
    ...
    override suspend fun load(
        ...
        try {
            ...
            database.withTransaction {
                ...
                database.storyDao().insertAll(responseData.listStory)
            }
